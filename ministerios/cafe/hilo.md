...
- El dictamen IGAE del 11-sep (cuánto dinero real hay para reasignar) — hilo activo.
- La huelga sanitaria del 3-oct y las 12.824 plazas MIR/EIR.
- El hueco de las 21:00 en el precio de la luz (gas vs baterías, art. 15) — hilo activo.
- La sequía Segura/Júcar/Ebro (<57% umbral) y la "reserva hídrica" sin partida.
...
|- 09-08: Barómetro CIS: 81 % cree que sanidad ha empeorado o sigue igual (81/100); deuda 1.762.650 M€ (101,49 % PIB), prima de riesgo 44 pts sobre Bund; luz 151,73 €/MWh (max 230); Segura 53,2 %, Júcar 54,3 %, Ebro 54,5 %; Arcadi abre primera vez la "bifurcación" (escenario donde todo se cae: CPFF cae en Congreso → reasignaciones caen); Mónica gira anillo corazón→índice→corazón; "el ochenta y uno se convierte en ochenta y nueve" si el 3-oct no hay guardias; Arcadi promete pedir dictamen IGAE antes de las 9; Sara se queda en el despacho revisando anexos del informe de sequía (no viene al café); verdad: deuda >101 % PIB + 44 pts riesgo = cada euro no aplicado cuesta más cada minuto; la desconfianza del 81 % es más vieja que CPFF que las leyes que simplifican.
|- **No repetir** como tema central: Presupuestos inviables / CPFF / sequía / guardias. Solo callback en una frase.

## Escenas anteriores
||- 09-18: Cocina del piso de Arcadi (por primera vez, fuera de cafetería). Tema central: bonificaciones a carburantes vs reasignaciones. Huelga indefinida confirmada formalmente (11-sep) por todos los sindicatos — ya no es amenaza, es countdown. IPC 4,3% en agosto, Funcas prevé 5% en septiembre. Prima de riesgo sube a 46,6 bps (desde 44 del 08-sep). Arcadi sin respuesta del IGAE, sin dictamen. Verdad: cada euro de bonificación a carburante es un euro que se lleva el mercado cuando no está la reasignación. No hay reasignación sin cifra IGAE, no hay cifra sin dictamen (fatal 11-sep ya pasado). Gesto: Arcadi deja las tres cucharas sobre la encimera, apaga la luz y no se la vuelve a encender. Sara dice «miedo» por primera vez en una conversación. Mónica se queda frase ajena: «el 28 de octubre no es viernes».
